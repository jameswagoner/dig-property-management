            ...
            <div class="px-2 space-y-1">
                ...
                <a href="{{ route('manage.dashboard') }}"
                    class="{{ Arr::toCssClasses([
                        ...
                        'text-steel-100 hover:text-white hover:bg-steel-600' => !Str::contains(Route::currentRouteName(), 'manage.dashboard'),
                        'bg-steel-800 text-white' => Str::contains(Route::currentRouteName(), 'manage.dashboard')
                    ]) }}"
                >
