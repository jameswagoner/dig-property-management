<x-app-layout title="{{ $unit->name }}">
    ...
    <div class="mt-8">
        <div class="max-w-6xl mx-auto mt-8 px-4 flex justify-between sm:px-6 lg:px-8">
            <h2 class="text-lg leading-6 font-medium text-gray-900">
                Rent / Utility Payments
            </h2>
            <a href="{{ route('manage.payments.enter') }}" class="rounded-md border border-gray-300 shadow-sm px-3 py-1 bg-white text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none">
                Add
            </a>
        </div>
    ...
    <div class="mt-8">
        <div class="max-w-6xl mx-auto mt-8 px-4 flex justify-between sm:px-6 lg:px-8">
            ...
            <a href="{{ route('manage.expenses.enter') }}" class="rounded-md border border-gray-300 shadow-sm px-3 py-1 bg-white text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none">
                Add
            </a>
        </div>
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="mt-8">
        <div class="max-w-6xl mx-auto mt-8 px-4 flex justify-between sm:px-6 lg:px-8">
            ...
            <a href="{{ route('manage.labor.enter') }}" class="rounded-md border border-gray-300 shadow-sm px-3 py-1 bg-white text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none">
                Add
            </a>
        </div>
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
