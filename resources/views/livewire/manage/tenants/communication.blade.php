        ...
        <x-header.breadcrumbs>
            <li>
                <div class="flex items-center">
                    ...
                    <a href="{{ route('manage.settings') }}" class="ml-4 text-sm font-medium text-gray-500">
                        Manage
                    </a>
                </div>
            </li>
            ...
            <li>
                <div class="flex items-center">
                    ...
                    <a href="{{ route('manage.tenants') }}" class="ml-4 text-sm font-medium text-gray-500 hover:text-gray-700">
                        Tenants
                    </a>
                </div>
            </li>
                ...
                <div class="bg-white py-6 px-4 sm:p-6">
                    <div class="lg:grid lg:grid-cols-12 lg:gap-x-5">
                        ...
                        <div class="sm:px-6 lg:px-0 lg:col-span-9">
                            <div class="bg-gray-50 py-6 px-4 sm:p-6 sm:rounded-lg">
                                <h2>Hey</h2>
                            </div>
                    </div>
                </div>
