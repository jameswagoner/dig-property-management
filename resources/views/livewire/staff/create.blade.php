    ...
    <div class="px-6 bg-white shadow sm:rounded-lg">
        ...
        <div class="py-5">
            <div class="flex justify-end">
                ...
                <button wire:click="save" class="ml-3 inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none">
                    Save
                </button>
            </div>
        </div>
