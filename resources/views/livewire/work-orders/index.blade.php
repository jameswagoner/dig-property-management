        ...
        <x-header.breadcrumbs>
            <li>
                <div class="flex items-center">
                    ...
                    <span class="ml-4 text-sm font-medium text-gray-500">
                        <a href="{{ route('work-orders.pending') }}">Incoming Requests</a>
                    </span>
                </div>
            </li>
        </x-header.breadcrumbs>
    ...
    <div class="max-w-3xl mx-auto lg:max-w-7xl sm:px-6">
        <div class="md:flex md:items-center md:justify-between">
            ...
            <div class="mt-4 flex md:mt-0 md:ml-4">
                <button type="button" class="ml-3 inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-orange-600 hover:bg-orange-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500">
                    New Work Order
                </button>
            </div>
        </div>
                            ...
                            <div class="flex items-center justify-between space-x-4">
                                ...
                                <div class="min-w-0 space-y-3">
                                    <div class="flex items-center space-x-3">
                                        <span class="h-4 w-4 bg-{{ $workOrder->status_color }}-100 rounded-full flex items-center justify-center">
                                            <span class="h-2 w-2 bg-{{ $workOrder->status_color }}-400 rounded-full"></span>
                                        </span>
                                        <span class="block">
                                ...
                                <div class="hidden sm:flex flex-col flex-shrink-0 items-end space-y-3">
                                    ...
                                    <p class="flex text-gray-500 text-sm leading-5 space-x-2">
                                        ...
                                        <span class="flex space-x-1">
                                            ...
                                            <span>{{ $workOrder->created_at->diffForHumans() }}</span>
                                        </span>
                                    </p>
                                </div>
                            </div>
